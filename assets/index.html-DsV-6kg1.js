import{_ as n,c as a,a as e,o as i}from"./app-BOzlqysc.js";const l="/blog/assets/1-BV5-OazZ.png",p="/blog/assets/2-B4U0gflr.png",t={};function c(r,s){return i(),a("div",null,s[0]||(s[0]=[e('<ul><li>创建一个空 windows 程序空项目</li><li>右键项目选择 生成依赖项 -&gt; 生成自定义 -&gt; 选择 masm</li></ul><p><img src="'+l+'" alt="" width="648" height="785"></p><p><img src="'+p+`" alt="" width="1440" height="759"></p><ul><li>新建一个空的 cpp 文件，后缀自己换成 .asm</li><li>右键项目选择 属性 -&gt; 链接器 -&gt; 系统 -&gt; 子系统 -&gt; 控制台 (/SUBSYSTEM:CONSOLE)</li><li>右键项目选择 属性 -&gt; 链接器 -&gt; 系统 -&gt; 高级 -&gt; 入口点(自己填 main)</li><li>选中生成的文件右键属性 -&gt; 常规 -&gt; 项类型(选择 Microsoft Macro Assembler)</li><li>选中 x64 直接运行</li></ul><p>以下是汇编代码版的 Hello World</p><div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki one-dark-pro vp-code"><code><span class="line"><span>EXTERN GetStdHandle : PROC</span></span>
